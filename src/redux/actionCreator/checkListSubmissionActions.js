...
export const downloadSubmission = ({secureUrl}) => ({
  type: DOWNLOAD_SUBMISSION,
  secureUrl
});
      
export const downloadSubmissionSuccess = ({submissions, message, success}) => ({
...
export const downloadSubmissionFailure = (error) => ({
  type: DOWNLOAD_SUBMISSION_FAILURE,
  error
});
